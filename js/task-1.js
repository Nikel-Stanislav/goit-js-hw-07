...
const ulCategory = document.querySelector(`#categories`);
const ulCategoryLi = ulCategory.querySelectorAll(".item");

console.log(`Number of categories: ${ulCategoryLi.length}`);
ulCategoryLi.forEach((item) => {
